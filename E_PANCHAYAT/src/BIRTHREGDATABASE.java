...
public class BIRTHREGDATABASE {
	
	public void birthreg(javabeans mn){
    	...
    	try {
    		...
    		String i = mn.getFather_name();
    		String j = mn.getMother_name();
    		int k = Integer.parseInt(mn.getAge_father());
    		int l = Integer.parseInt(mn.getAge_mother());
    		String m = mn.getFather_occupation();
    		String n = mn.getMother_occupation();
    		int o = Integer.parseInt(mn.getChild_weight());
    		String p = mn.getMethod_of_delivery();
    		String q = mn.getRelegion();
    		String r = mn.getPer_address();
    		double s = Double.parseDouble(mn.getPincode());
    		String t = mn.getState();
    		
    		
    		Connection conn = getConn.getConnection();
    		Statement stmt = conn.createStatement();
    		
    		String query = "insert into tempBirth values('"+a+"','"+b+"',"+c+",'"+d+"','"+e+"','"+f+"','"+g+"','"+h+"','"+i+"','"+j+"',"+k+","+l+",'"+m+"','"+n+"',"+o+",'"+p+"','"+q+"','"+r+"',"+s+",'"+t+"')";
