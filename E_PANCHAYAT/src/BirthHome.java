...
public class BirthHome extends JFrame implements TreeSelectionListener {
	...
	public BirthHome() throws IOException
	{
		setTitle("BIRTH DETAILS");
		
		co = getContentPane();
		co.setLayout(null);
		
		DefaultMutableTreeNode title = new DefaultMutableTreeNode("<HTML><b>BIRTH DETAILS</b><HTML>");
		
		DefaultMutableTreeNode app= new DefaultMutableTreeNode("Apply Birth Registration");
		DefaultMutableTreeNode gen = new DefaultMutableTreeNode("Generate Birth Details");  
		...
		topic = new JLabel("   BIRTH DETAILS");
	    ...
	    BufferedImage wat = ImageIO.read(new File("C:\\Users\\MADHUSRI\\Desktop\\Images\\b.jpg"));
	    BufferedImage resized1 = resize(wat, 200, 200);
	    JLabel label1 = new JLabel(new ImageIcon(resized1));
	    bIcon1.add(label1);
	    bIcon1.setBounds(370,60,200,200);
	    bIcon1.setBackground(Color.white);
	    
	    JPanel bIcon2 = new JPanel();
	    BufferedImage dis = ImageIO.read(new File("C:\\Users\\MADHUSRI\\Desktop\\Images\\r.jpg"));
	    BufferedImage resized2 = resize(dis, 500, 500);
	...
	public void valueChanged(TreeSelectionEvent se) {
	    ...
	    if(!str.isEmpty()) {
	    	try {
	    		...
	    		System.out.println("BirthHome"+e);
	    	}
	    }
